...
proc create_root_design { parentCell } {
  ...
  set a [ create_bd_intf_port -mode Slave -vlnv xilinx.com:interface:axis_rtl:1.0 a ]
  ...
  set b [ create_bd_intf_port -mode Slave -vlnv xilinx.com:interface:axis_rtl:1.0 b ]
  set_property -dict [ list \
   CONFIG.FREQ_HZ {333000000.0} \
   CONFIG.HAS_TKEEP {0} \
   CONFIG.HAS_TLAST {0} \
  ...
  set c [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:axis_rtl:1.0 c ]
  set_property -dict [ list \
   CONFIG.FREQ_HZ {333000000.0} \
   ] $c
  ...
  set hls_inst [ create_bd_cell -type ip -vlnv xilinx.com:hls:adder:1.0 hls_inst ]

  # Create interface connections
  connect_bd_intf_net -intf_net a_0_1 [get_bd_intf_ports a] [get_bd_intf_pins hls_inst/a]
  connect_bd_intf_net -intf_net ap_ctrl_0_1 [get_bd_intf_ports ap_ctrl] [get_bd_intf_pins hls_inst/ap_ctrl]
  connect_bd_intf_net -intf_net b_0_1 [get_bd_intf_ports b] [get_bd_intf_pins hls_inst/b]
  connect_bd_intf_net -intf_net hls_inst_c [get_bd_intf_ports c] [get_bd_intf_pins hls_inst/c]
